      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title" style="font-weight: bold;">Kotak Masuk</h3>
            ...
            <div class="box-body no-padding">
              ...
              <?php
                $nama = $_SESSION['namle'];
                $sql = "SELECT * FROM pesan WHERE nama_penerima = '$nama'";
                $query = $sql;
              ?>
            <form method="get" name="proses">
                    ...
                    <?php
                      ...
                      <tr>
                        <td>
                          ...
                          <a href="del_pesan.php?id=<?=$data['id']?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data')" class="btn btn-default btn-sm"><i class="fa fa-trash-o"></i></a>
                          </button>
                        </td>
                        ...
                        <td class="mailbox-name">
                          <a href="isi_pesan.php?id=<?=$data['id']?>"><?=$data['nama_pengirim']?></a>
                        </td>
