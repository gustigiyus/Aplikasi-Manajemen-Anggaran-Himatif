...
<head>
  ...
  <title>MAHTI | Management Anggaran Politeknik</title>
      ...
      <div class="navbar-custom-menu">
        ...
        <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header" style="font-weight: bold;"><?php echo mysqli_num_rows($users);?> Penyelesaian belum di Setujui</li>            
              <li>
                <ul class="menu">
                <?php
                  $users = mysqli_query($con, "SELECT * FROM tb_penyelesaian WHERE status = 'Pending'") or die (mysqli_error($con)); 
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <ul class="menu">
                <?php
                  $users = mysqli_query($con, "SELECT nama_aktivitas, jenis_pengeluaran, total_kel, id_rencana, id_rencana_kel, status_kel, id_pengeluaran FROM tb_rencana INNER JOIN tb_pengeluaran ON tb_pengeluaran.id_rencana_kel=tb_rencana.id_rencana WHERE status_kel = 'Diajukan'") or die (mysqli_error($con)); 
                    if (mysqli_num_rows($users) > 0) {
                      while ($data = mysqli_fetch_array($users)) { ?>
                  <li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <ul class="menu">
                <?php
                  $users = mysqli_query($con, "SELECT nama_aktivitas, keterangan, total, id_rencana, id_rencana_pem, id_keterangan, status_pem FROM tb_rencana INNER JOIN tb_pemasukan ON tb_pemasukan.id_rencana_pem=tb_rencana.id_rencana WHERE status_pem = 'Diajukan'") or die (mysqli_error($con)); 
                    if (mysqli_num_rows($users) > 0) {
                      while ($data = mysqli_fetch_array($users)) { ?>
                  <li>
        ...
        <!-- NOTIFIKASI PENGAJUAN RENCANA -->
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header" style="font-weight: bold;"><?php echo mysqli_num_rows($users);?> Rencana belum di Setujui</li>
              <li>
                <ul class="menu">
                <?php
                  $users = mysqli_query($con, "SELECT * FROM tb_rencana WHERE status = 'Diajukan'") or die (mysqli_error($con)); 
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../../gambar/icons/himatif.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['user']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../../gambar/icons/himatif.jpg" class="img-circle" alt="User Image">
                <p>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="../Setting/settinguser.php" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> Bendahara</a>
        </div>
      </div>
      <br>
      <!-- sidebar menu -->
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?=base_url('user/rencana/data.php')?>">
            <i class="fa fa-calendar-o"></i> <span>Pengajuan Rencana</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-fax"></i> <span>Pengajuan Anggaran</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?=base_url('user/pengajuan_pemasukan/data.php')?>"><i class="fa fa-hand-o-right"></i> Anggaran Pemasukan</a></li>
            <li><a href="<?=base_url('user/pengajuan_pengeluaran/data.php')?>"><i class="fa fa-hand-o-right"></i> Anggaran Pengeluaran</a></li>
          </ul>
        </li>
        <li>
          <a href="<?=base_url('user/penyelesaian/data.php')?>">
            <i class="fa fa-briefcase"></i> <span>Penyelesaian Anggaran</span>
          </a>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=base_url('user/laporan/laporan_rencana.php')?>"><i class="fa fa-calendar-o"></i> Laporan Rencana</a></li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?=base_url('user/laporan/laporan_pemasukan.php')?>"><i class="fa fa-circle-o"></i> Laporan Pemasukan</a></li>
                <li><a href="<?=base_url('user/laporan/laporan_pengeluaran.php')?>"><i class="fa fa-circle-o"></i> Laporan Pengeluaran</a></li>
              </ul>
            </li>
          </ul>
        </li>
        <li>
          <a href="<?=base_url('user/inbox/kotak_masuk.php')?>">
