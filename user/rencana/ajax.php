...
while ($row = mysqli_fetch_array($result)) {
     ...
     // Update Button
     $updateButton = "<a href='edit.php?id=".$row['id_rencana']."' class='btn btn-warning btn-xs'><i class='fa fa-edit'></i> Edit</a>";

     // Delete Button
     $deleteButton = "<a href='del.php?id=".$row['id_rencana']."' onclick='hapus()' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i> Hapus</a>";
