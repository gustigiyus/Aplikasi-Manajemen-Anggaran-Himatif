                ...
                <div class="row">
                    ...
                    <form action="proses.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="idpenye" value="<?=$data['id_rencana_penye']?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" value="<?=$data['dana_pemasukan']?>" name="dana_pemasukan" id="msk" class="form-control" required>
                                <input disabled type="number" value="<?=$data['dana_pemasukan']?>" name="dana_pemasukan_false" id="msk" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" value="<?=$data['dana_pengeluaran']?>" name="dana_pengeluaran" id="klr" class="form-control" required>
                                <input disabled type="number" value="<?=$data['dana_pengeluaran']?>" name="dana_pengeluaran_false" id="klr" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" value="<?=$data['selisih']?>" name="selisih" id="hsl" class="form-control" required>
                                <input disabled type="number" value="<?=$data['selisih']?>" name="selisih_false" id="hsl" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="keterangan">Keterangan</label>
                            <textarea class="form-control" rows="5" name="keterangan" id="keterangan" placeholder="*Boleh Diisi atau Tidak tergantung situasi"><?=$data['keterangan']?></textarea>
                        </div>
                        ...
                        <input type="hidden" name="edit_status" class="form-control" value="Pending" required>
                        <div class="form-group">
