...
?>
    ...
    <section class="content-header">
        <h1>
            EDIT PERSETUJUAN PEMASUKAN ANGGARAN
            <small>Kelola Persetujuan Pemasukan Anggaran</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="../dashboard/index.php"><i class="fa fa-dashboard"></i></a></li>
            <li class="active">Edit Persetujuan Pemasukan Anggaran</li>
        </ol>
    </section>
            ...
            <table class="table table-striped">
                <thead style="border-bottom: 3px solid red;">
                    <tr>
                        ...
                        <th style="background-color: #E6E6FA; text-align: center;">Jumlah</th>
                        <th style="background-color: #E6E6FA; text-align: center;">Harga</th>
                        <th style="background-color: #E6E6FA; text-align: center;">Total</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center">Rp. <?php echo number_format($data['total']); ?></td>
                        <td>
                            <select name="status[]" class="form-control" required>
                                <option value="<?=$data['status_pem']?>">
                                    <?=$data['status_pem']?>
                                </option>
