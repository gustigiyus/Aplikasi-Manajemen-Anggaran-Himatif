      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="small-box bg-aqua">
            <a href="../Persetujuan-Rencana/data.php" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-yellow"><i class="fa fa-users"></i></span>
             <div class="info-box-content">
              ...
              <span class="info-box-number">
              <?php 
                $users = mysqli_query($con, "SELECT * FROM login WHERE level != 'Admin'") or die (mysqli_error($con));
                echo mysqli_num_rows($users); 
              ?>
              </span>
            </div>
          ...
          <div class="small-box bg-yellow">
            <a href="../Setting/settinguser.php" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
